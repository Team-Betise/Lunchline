...
import com.betise_lunchline_vendor.app.modules.SharedObjects.Companion.dishes
...
class AddDishActivity : BaseActivity<ActivityAddDishBinding>(R.layout.activity_add_dish) {
	...
	override fun setUpClicks(): Unit {
		...
		binding.btnSave.setOnClickListener {
			saveData()
			val dish = SharedObjects.Dish(name!!,price!!,description!!,true,0.00,0,com.google.firebase.Timestamp(((sthrs!!*60+stmin!!)*60).toLong(), 0), com.google.firebase.Timestamp(((edhrs!!*60+edmin!!)*60).toLong(), 0),days,com.google.firebase.Timestamp(((etahrs!!*60+etamin!!)*60).toLong(), 0))
			addDish(dish)
			printData()
